...
bool:is_allowed_msr_read(msr) {
    switch (msr) {
        case MSR_AMD64_PATCH_LEVEL, MSR_CORE_ENERGY_STAT, MSR_HARDWARE_PSTATE_STATUS,
             ...
             MSR_AMD_CPPC_REQ, MSR_AMD_CPPC_STATUS, MSR_PSTATE_STATUS, MSR_PSTATE_0, MSR_PSTATE_1,
             MSR_PSTATE_2, MSR_PSTATE_3, MSR_PSTATE_4, MSR_PSTATE_5, MSR_PSTATE_6, MSR_PSTATE_7,
